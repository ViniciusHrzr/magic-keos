  ...
  corpo: {
    artesMarciais: {
      ...
      proficiencias: [
        ...
        { nome: 'Aparar (reação lv.2)', descricao: 'Intercepção de ataque físico com corpo ou arma. Sucesso: metade do dano e pode aplicar imediatamente uma manobra.', teste: 'REF [Artes Marciais] oposto ao atacante — reação [1]', requisito: 'Requer Artes Marciais lv.2' },
      ],
    },
    atletismo: {
      label: 'Atletismo',
      ...
      proficiencias: [
        ...
        { nome: 'Disparar (reação lv.1)', descricao: 'Movimentação de fuga ou avanço rápido como resposta a um evento. Sucesso permite mover 9m extras.', teste: 'REF [Atletismo] vs. dificuldade 15 — reação [1]', requisito: 'Requer Atletismo lv.1' },
      ],
    },
    esgrima: {
      label: 'Esgrima',
      ...
      proficiencias: [
        ...
        { nome: 'Contra-atacar (reação lv.2)', descricao: 'Quando o adversário erra um ataque corpo a corpo, realiza imediatamente um contra-ataque.', teste: 'REF [Esgrima] oposto ao atacante que errou — reação [1]', requisito: 'Requer Esgrima lv.2' },
      ],
    },
    furtividade: {
      label: 'Furtividade',
      ...
      proficiencias: [
        ...
        { nome: 'Esquivar (reação lv.1)', descricao: 'Evita completamente um ataque com desvio no último momento. Sucesso: zero dano.', teste: 'REF [Furtividade] oposto ao atacante — sucesso: dano zerado — reação [1]', requisito: 'Requer Furtividade lv.1' },
      ],
    },
    pontaria: {
      label: 'Pontaria',
      ...
      proficiencias: [
        ...
        { nome: 'Mirar (reação lv.2)', descricao: 'Ajuste cuidadoso de mira que acumula bônus para o próximo ataque de Pontaria.', teste: 'REF [Pontaria] — bônus acumulado ao próximo disparo — reação [1]', requisito: 'Requer Pontaria lv.2' },
      ],
    },
  },
  mente: {
    alquimia: {
      ...
      proficiencias: [
        ...
        { nome: 'Poções (lv.1)', descricao: 'Cria poções alquímicas durante o descanso. O resultado depende do teste.', teste: 'RAZ [Alquimia] no descanso — falha: reduzido · 10+: pretendido · 20+: potencializado', requisito: 'Requer Alquimia lv.1' },
      ],
    },
    criatividade: {
      label: 'Criatividade',
      ...
      proficiencias: [
        ...
        { nome: 'Solução (lv.1)', descricao: 'Improvisa respostas eficazes a problemas inéditos sem recursos ou ferramentas ideais.', teste: 'RAZ [Criatividade] vs. dificuldade do problema', requisito: 'Requer Criatividade lv.1' },
      ],
    },
    investigacao: {
      label: 'Investigação',
      ...
      proficiencias: [
        ...
        { nome: 'Leitura (lv.1)', descricao: 'Decifra textos arcanos, runas, mapas antigos e manuscritos mágicos.', teste: 'RAZ [Investigação] — dificuldade varia com antiguidade e complexidade', requisito: 'Requer Investigação lv.1' },
      ],
    },
    mecanica: {
      label: 'Mecânica',
      ...
      proficiencias: [
        ...
        { nome: 'Artefatos (lv.1)', descricao: 'Ativa artefatos gastando 1 mana incolor e repara cargas perdidas durante o descanso.', teste: 'Ativar: ação [1] + 1 mana incolor · Reparar (CON [Mecânica]): 10+:1 · 15+:2 · 20+:3', requisito: 'Requer Mecânica lv.1' },
      ],
    },
    sobrevivencia: {
      label: 'Sobrevivência',
      ...
      proficiencias: [
        ...
        { nome: 'Coleta (lv.1)', descricao: 'Recolhe matérias-primas (ervas, minerais, ossadas) durante períodos de descanso.', teste: 'RAZ [Sobrevivência] no descanso — 10+:1 · 15+:2 · 20+:3 · 25+:4 · 30+:5', requisito: 'Requer Sobrevivência lv.1' },
      ],
    },
  },
  espirito: {
    comunhao: {
      ...
      proficiencias: [
        { nome: 'Provocar (ação livre lv.3)', descricao: 'Força inimigo a direcionar todos os ataques a você por uma rodada. Não custa ação.', teste: 'PRE [Comunhão] vs. VON do alvo — sucesso: alvo provocado por 1 rodada', requisito: 'Requer Comunhão lv.3' },
      ],
    },
    diplomacia: {
      label: 'Diplomacia',
      ...
      proficiencias: [
        { nome: 'Coordenar (ação livre lv.3)', descricao: 'Concede ação padrão extra a um aliado neste turno por coordenação tática. Não custa ação.', teste: 'INT [Diplomacia] — sucesso automático se aliado estiver presente e ativo', requisito: 'Requer Diplomacia lv.3' },
      ],
    },
    expressao: {
      label: 'Expressão',
      ...
      proficiencias: [
        { nome: 'Inspirar (ação livre lv.3)', descricao: 'Concede vantagem (+1d20) a um aliado no próximo teste com palavras ou gestos. Não custa ação.', teste: 'PRE [Expressão] — sucesso automático se aliado puder ouvi-lo', requisito: 'Requer Expressão lv.3' },
      ],
    },
    intimidacao: {
      label: 'Intimidação',
      ...
      proficiencias: [
        { nome: 'Amedrontar (ação livre lv.3)', descricao: 'Impõe desvantagem (−1d20) a um inimigo no próximo teste por presença aterrorizante. Não custa ação.', teste: 'VON [Intimidação] vs. VON do alvo — sucesso: desvantagem no próximo teste', requisito: 'Requer Intimidação lv.3' },
      ],
    },
    labia: {
      label: 'Lábia',
      ...
      proficiencias: [
        { nome: 'Distrair (ação livre lv.3)', descricao: 'Remove a reação disponível de um alvo até o próximo turno por distração verbal ou gestual. Não custa ação.', teste: 'INT [Lábia] vs. INT do alvo — sucesso: alvo sem reação até próximo turno', requisito: 'Requer Lábia lv.3' },
      ],
    },
  },
};
